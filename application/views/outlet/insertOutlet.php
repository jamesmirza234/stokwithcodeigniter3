            ...
            <div class="row">
                <div class="col-md-12"> <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="glyphicon glyphicon-plus"></i> Tambah Data Outlet</h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>outlet/insert" >
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-lg-4">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" name="alamaOutlet" class="form-control" required>
                                </div>
